...
if [ -z "$JAVA_HOME" ]
then
  echo "Missing environment variable -- JAVA_HOME"
  echo "JAVA_HOME should point to the root directory of the 1.3 JDK."
...
# Include all files in the ant lib directory and the Java tools.jar file.
CP=.:${JAVA_HOME}/lib/tools.jar
for i in `find ../../../Support/ant | egrep '\.jar$'` ; do
  CP=${CP}:$i
done
